            ...
            <div class="header-wrapper">
                <div class="row justify-content-between">
                    ...
                    <div class="col-lg-5 text-end">
                        <p>Our database currently contain <span class="text-white">8794</span> files.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="box_shadow">
                    <div class="of_wrapper">
                        <div class="row justify-content-between of-header">
                            <div class="col-lg-5">
                                <h3 class="text-second">Original ECU Files Database</h3>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <table class="table table-striped table-hover table-borderless table-sm">
                                    <thead>
                                        <tr>
                                            <th scope="col" class="text-start">brand/Model</th>
                                            <th scope="col">Engine</th>
                                            <th scope="col">ECU</th>
                                            <th scope="col">HW No.</th>
                                            <th scope="col">SW No.</th>
                                            <th scope="col">Read Meth</th>
                                            <th scope="col">ECU Prod.</th>
