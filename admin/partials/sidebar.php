	...
	<div class="geex-sidebar__wrapper">
		...
		<nav class="geex-sidebar__menu-wrapper">
			<ul class="geex-sidebar__menu">
				...
				<li class="geex-sidebar__menu__item has-children">
					<a href="add-a-car" class="geex-sidebar__menu__link">
						<?php include 'resources/svgs/car.php'; ?>
						<span>Add A Car</span>
					</a>
				</li>

				<li class="geex-sidebar__menu__item has-children">
					<a href="user-credits" class="geex-sidebar__menu__link">
						<?php include 'resources/svgs/coin.php'; ?>
						<span>Customer Credits</span>
					</a>
				</li>

				<li class="geex-sidebar__menu__item has-children">
					<a href="user-files" class="geex-sidebar__menu__link">
						<?php include 'resources/svgs/file.php'; ?>
						<span>Users Files</span>
					</a>
				</li>
				<li class="geex-sidebar__menu__item has-children">
					<a href="add-credits" class="geex-sidebar__menu__link">
						<?php include 'resources/svgs/add-coins.php'; ?>
						<span>Add Credits</span>
					</a>
				</li>
				<li class="geex-sidebar__menu__item has-children">
					<a href="price-list" class="geex-sidebar__menu__link">
						<?php include 'resources/svgs/price-tag.php'; ?>
		...
		<div class="geex-sidebar__footer">
			<span class="geex-sidebar__footer__title">GTS Dashboard</span>
			<p class="geex-sidebar__footer__copyright">© 2024 All Rights Reserved</p>
			<p class="geex-sidebar__footer__author position-relative">Made with <span class="heart-icon">♥</span> by <a
					href="#" class="ft-mark">Living
					&nbsp;Code</a></p>
		</div>
	</div>
</div>
